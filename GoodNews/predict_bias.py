...
def train_save_model(dataset,embd):
    ...
    gate_model = Dense(3, activation='softmax')(encode_title)
    ...
    if os.path.isfile('models/'+ embd + '/' + dataset + '/MODEL.h5') == False:
        ...
        gate_model.fit([trainque_feature], trainans, epochs=10, batch_size=128, validation_data=([validque_feature], validans), callbacks=callbacks_list, verbose=1)
